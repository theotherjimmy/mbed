...
#define PSA_ITS_ERROR_FLAGS_SET_AFTER_CREATE    3   /**<    The operation failed because a non-zero `create_flags` was provided for a previously created key */
...
#define PSA_ITS_ERROR_INVALID_KEY               5   /**<    The operation failed because the key value provided was invalid */
...
#define PSA_ITS_ERROR_INCORRECT_SIZE            9   /**<    The operation failed because the data associated with provided key is not the same size as `data_size` */
#define PSA_PS_ERROR_OFFSET_INVALID            10   /**<    The operation failed because an offset was supplied that is invalid for the existing data associated with the uid. For example, offset + size is
